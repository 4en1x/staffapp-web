...
-- Schema exdl
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `exdl` DEFAULT CHARACTER SET utf8 ;
USE `exdl` ;

-- -----------------------------------------------------
-- Table `exdl`.`cities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`cities` (
...
-- Table `exdl`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`users` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exdl`.`candidates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`candidates` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_candidates_cities1`
    FOREIGN KEY (`city_id`)
    REFERENCES `exdl`.`cities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_candidates_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `exdl`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- Table `exdl`.`vacancy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`vacancy` (
  `id` INT(11) NOT NULL,
...
-- Table `exdl`.`hirings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`hirings` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
...
-- Table `exdl`.`history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`history` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exdl`.`interviews`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`interviews` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Table `exdl`.`skills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`skills` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `exdl`.`interviews_has_skills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`interviews_has_skills` (
  ...
  CONSTRAINT `fk_interviews_has_skills_interviews1`
    ...
    REFERENCES `exdl`.`interviews` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_interviews_has_skills_skills1`
    FOREIGN KEY (`skills_id`)
    REFERENCES `exdl`.`skills` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exdl`.`interviews_has_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`interviews_has_users` (
  `interviews_id` INT(11) NOT NULL,
...
-- Table `exdl`.`links`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`links` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Table `exdl`.`messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`messages` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exdl`.`primary_expirience`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`primary_expirience` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `candidate_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exdl`.`skills_has_candidates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`skills_has_candidates` (
  `skills_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exdl`.`vacancy_has_skills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`vacancy_has_skills` (
...
-- Table `exdl`.`feedback`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`feedback` (
...
-- -----------------------------------------------------
-- Table `exdl`.`feedback_fields`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exdl`.`feedback_fields` (
  `id` INT NOT NULL AUTO_INCREMENT,
